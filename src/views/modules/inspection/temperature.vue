    ...
    <div class="show-data-table">
      ...
      <el-tab-pane label="图表" name="chart" actived="true">
        <div :style="{ 'height': chartHeight + 'px' }">
          <component v-show="hasData===true" :is="chartType" ref="chart" :unNormal="unNormal" :normal="normal" :all="all" :category="category" :legend="legend" :series="series" title="温度数据图表" @dblclick="chartDblClick"></component>
