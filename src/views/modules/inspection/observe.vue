  ...
  <div class="mod-observe">
    ...
    <split-pane split="vertical" ref="splitPane"  :min-percent="0" :default-percent="curPercent" @resize="resize">
      <template slot="paneL" >
        ...
        <linetree inspectionType="8" @TreeSelectEvent="handleDeptSelect" v-if="this.isDrawBack===false"></linetree>
        </div>
      </template>
   <template slot="paneR">
    <div class="show-data-table">
      ...
      <el-tab-pane label="图表" name="chart" actived="true">
        <div :style="{ 'height': chartHeight + 'px' }">
          <component v-show="hasData===true" :is="chartType" ref="chart" :unNormal="unNormal" :normal="normal" :all="all" :category="category" :legend="legend" :series="series" title="观察数据图表"></component>
