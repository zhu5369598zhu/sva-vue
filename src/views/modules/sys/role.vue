  ...
  <div class="mod-role">
    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:role:save')" type="primary" @click="roleAddOrUpdateHandle()">新增</el-button>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <roleAddOrUpdate v-if="roleAddOrUpdateVisible" ref="roleAddOrUpdate" @refreshDataList="getDataList"></roleAddOrUpdate>
  </div>
  </div>
</template>
  ...
  export default {
    data () {
      return {
        ...
        roleMenuAddOrUpdateVisible: false
      }
    },
    components: {
      roleAddOrUpdate
    ...
    methods: {
      ...
      // 新增 / 修改
      roleMenuAddOrUpdateHandle (id) {
        this.roleMenuAddOrUpdateVisible = true
        this.$nextTick(() => {
          // this.$refs.roleMenuAddOrUpdate.init(id)
        })
      },
      // 删除
      deleteHandle (id) {
