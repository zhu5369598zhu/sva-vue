<template>
  <div class="mod-config">
    ...
    <el-form :inline="true" :model="dataForm">
      <el-form-item>
        <el-button v-if="isAuth('setting:baseturn:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('setting:baseturn:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      ref="table"
...
<script>
  import AddOrUpdate from './baseturn-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/setting/baseturn/delete'),
            method: 'post',
