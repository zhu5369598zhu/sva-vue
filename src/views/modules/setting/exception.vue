<template>
  <div class="mod-config" style="height: 100%;">
    ...
    <el-form :inline="true" :model="dataForm">
      <el-form-item>
        <el-button v-if="isAuth('setting:exception:save')" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('setting:exception:delete')" type="warning" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      ref="table"
