<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px" style="margin-left: -10px;">
      <p style="margin-left: 32px;">班前会日志(修改中)  &nbsp; &nbsp;&nbsp;&nbsp; 日志编号: {{dataForm.logNumber}}</p>
      <el-row>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="班次" prop="baseTurnId">
            <el-select size="mini" v-model="dataForm.baseTurnId" placeholder="请选择班次" clearable>
              <el-option
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="班长" prop="monitor">
            <el-input size="mini" v-model="dataForm.monitor" placeholder="班长"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-form-item label="实到人员" prop="actualArrival">
        <el-input size="mini" v-model="dataForm.actualArrival" placeholder="实到人员">
          <span slot="suffix">
      ...
      <el-form-item label="人员精神状态" prop="personnelMentalState">
        <!--<el-input size="mini" v-model="dataForm.personnelMentalState" placeholder="人员精神状态（1正常，2异常）"></el-input>-->
      ...
      <el-form-item label="危险点" prop="dangerousPoint">
        <el-input size="mini" type="textarea" autosize v-model="dataForm.dangerousPoint" placeholder="危险点"></el-input>
      </el-form-item>
      <el-form-item label="防范措施" prop="preventiveMeasures">
        <el-input size="mini" type="textarea" autosize v-model="dataForm.preventiveMeasures" placeholder="防范措施"></el-input>
      </el-form-item>
      <el-row>
        <el-col :span="12">
          <el-form-item label="交底人" prop="manAgreement">
            <el-input size="mini" v-model="dataForm.manAgreement" :disabled="true" placeholder="交底人"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="交底时间" prop="createTime">
            <el-date-picker v-model="dataForm.createTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"  @change="handleStartTimeChange" :picker-options="startDatePicker" style="width:100%;"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-form-item label="驳回人" prop="rejectPeople">
        <el-input size="mini" v-model="dataForm.rejectPeople" readonly></el-input>
      </el-form-item>
