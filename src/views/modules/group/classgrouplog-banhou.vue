<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px" style="margin-left: -5px;">
    <p style="margin-left: 32px;">班后会日志(拟制中)  &nbsp; &nbsp;&nbsp;&nbsp;   日志编号: {{dataForm.logNumber}}</p>
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="部门(工段)" prop="deptName">
          ...
          <el-input size="mini" v-model="dataForm.deptName"  v-popover:deptListPopover :readonly="true" class="dept-list__input" style="width:100%;" placeholder="部门">
      ...
      <el-col :span="8">
        <el-form-item label="班组" prop="classGroupName" label-width="100px">
          <el-input size="mini" v-model="dataForm.classGroupName" placeholder="班组" style="width: 100%;"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="班次" prop="baseTurnId" label-width="100px">
          <el-select v-model="dataForm.baseTurnId" placeholder="请选择班次" clearable style="width: 100%;" size="mini">
            <el-option
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="班长" prop="monitor">
          <el-input size="mini" v-model="dataForm.monitor" placeholder="班长" readonly></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="应出勤人数" prop="shouldAttendance" label-width="100px">
          <el-input size="mini" v-model="dataForm.shouldAttendance" placeholder="应出勤人数"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="实出勤人数" prop="attendance" label-width="100px">
    ...
    <el-form-item v-if="dataForm.personnelMentalState === '2'" label="异常描述" prop="mentalException">
    ...
    <el-form-item v-if="dataForm.laborProtectiveArticles ==='2'" label="异常描述" prop="protectiveException">
    ...
    <el-form-item v-if="dataForm.tools === '2'" label="异常描述" prop="toolsException">
    ...
    <el-form-item label="工作总结" prop="workSummary">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="交底时间" prop="createTime">
            <el-date-picker v-model="dataForm.createTime" type="datetime" value-format="yyyy-MM-dd HH:mm:00"  @change="handleStartTimeChange" :picker-options="startDatePicker" style="width:100%;" size="mini"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="班组成员" prop="teamMembers">
        <el-input size="mini" v-model="dataForm.teamMembers" placeholder="班组成员" :disabled="true">
              <span slot="suffix">
                <a  href="#"><img alt="" style="height: 25px;width: 25px; margin-top: -4px;" src="./../../../../static/img/renren.jpg" @click="clickTitle('班组成员')" ></a>
              </span>
        </el-input>
      </el-form-item>
    </el-form>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          deptName: [
            { required: true, message: '部门车间不能为空', trigger: 'blur' }
          ],
          classGroupName: [
    ...
    methods: {
      init (id, isok) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.classId && !isok) { // 修改
            this.$http({
              ...
              if (data && data.code === 0) {
                this.dataForm.classId = data.classgrouplog.classId
          ...
          } else if (this.dataForm.classId && isok) { // 新增回显
            this.$http({
              url: this.$http.adornUrl(`/group/classgrouplog/info/${this.dataForm.classId}`),
              method: 'get',
              params: this.$http.adornParams()
