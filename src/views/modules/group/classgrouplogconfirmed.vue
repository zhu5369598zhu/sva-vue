  ...
  <div class="mod-group" style="height: 100%;">
    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item  prop="user_id">
        <el-select v-model="dataForm.user_id" size="mini" placeholder="和我相关" clearable style="width: 130px;"  >
          <el-option
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="mini" v-if="scope.row.newsCounts ===0" :disabled="scope.row.newsCounts ===0" style="color: #8c939d;">去确认</el-button>
          <el-button type="text" size="mini" v-if="scope.row.rejectNewsCounts > 0" @click="rejectupdateHandle(scope.row.classId,scope.row.logStatus,scope.row.logType,scope.row.logNumber)">修改</el-button>
          <el-button type="text" size="mini" v-if="scope.row.rejectNewsCounts ===0" :disabled="scope.row.rejectNewsCounts ===0" style="color: #8c939d;">修改</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
