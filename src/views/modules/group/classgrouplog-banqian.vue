<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px" style=" margin-left: -8px;">
      <p style="margin-left: 32px;">班前会日志(拟制中)  &nbsp; &nbsp;&nbsp;&nbsp; 日志编号: {{dataForm.logNumber}}</p>
      <el-row>
        <el-col :span="8">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="交底人" prop="manAgreement">
            <el-input size="mini" v-model="dataForm.manAgreement" readonly placeholder="交底人"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
